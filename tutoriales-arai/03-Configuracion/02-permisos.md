...
node .opencode/skills/permission-creator/scripts/create-permission.js --strictness strict
node .opencode/skills/permission-creator/scripts/create-permission.js --strictness permissive
```
