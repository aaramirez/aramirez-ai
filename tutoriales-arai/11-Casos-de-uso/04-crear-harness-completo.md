...
```bash
node /path/to/arai/.opencode/skills/config-creator/scripts/create-config.js \
...
# Agente reviewer
node /path/to/arai/.opencode/skills/agent-creator/scripts/create-agent.js --mode subagent \
...
```bash
node /path/to/arai/.opencode/skills/architecture-creator/scripts/create-architecture.js \
...
```bash
node .opencode/skills/rule-creator/scripts/create-rule.js api-standards
