...
```bash
node .opencode/skills/config-creator/scripts/create-config.js --model opencode/big-pickle --output ./opencode.json
```
...
# Vista previa
node .opencode/skills/config-creator/scripts/create-config.js --dry-run
```
