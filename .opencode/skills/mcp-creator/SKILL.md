...
```bash
node .opencode/skills/mcp-creator/scripts/create-mcp.js --name github --type remote --url https://api.github.com/mcp --header "Authorization=Bearer {env:GITHUB_TOKEN}" --output ./mcp.json
```
