...
```bash
node .opencode/skills/command-creator/scripts/create-command.js --name test --description "Run tests" --template "Run test suite with coverage" --output ./command.json
```
